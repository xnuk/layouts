...
, ALL_T(KC_BSLS)   , KC_LALT   , KC_LCTL  , KC_LGUI   , LT(Layer_left_mod,KC_RIGHT)   , KC_SPC   , KC_SPC   , LT(Layer_right_mod,KC_LANG1)    , LT(Layer_mouse,KC_LEFT)   , KC_DOWN   , KC_UP     , KC_RIGHT
)
...
, KC_LGUI              , KC_LALT   , KC_LCTL  , KC_BSLS   , KC_LSFT , KC_SPC   , KC_LBRC  , KC_RSFT , KC_RBRC   , KC_RCTRL , KC_RALT   , KC_EQL
)
